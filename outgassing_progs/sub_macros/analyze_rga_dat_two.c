...
void analyze_rga_dat_two(TString fname="07282015_2_xe.dat", TString fname_bg="07282015_2_bg.dat", 
                         Double_t recorded_pressure=5.42e-5, Double_t recorded_pressure_bg=8.42e-7, Double_t input_mass = 0, 
...
////  Finding Peaks  ////
   ...
   for(int i = 0;i<npts;i++)
   {
     scaled_subtracted_partial_pressure = (y[i]*recorded_pressure/rga_pressure_integral) - (y_bg[i]*recorded_pressure_bg/rga_pressure_integral_bg);
