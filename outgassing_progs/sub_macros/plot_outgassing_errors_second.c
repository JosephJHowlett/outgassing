...
void plot_outgassing_errors_second(int n_measurements, vector<Double_t>& time_hrs, 
...
TF1 *fitfunc = new TF1("fitexp","[0] + expo(1)");
...
TLine * turboline = new TLine(68.7, 1.e-5, 68.7, 9.e-5);
turboline->SetLineColor(my_colors[plot_number]);
turboline->SetLineStyle(5);
turboline->Draw("same");
