...
void plot_outgassing_errors(int n_measurements, vector<Double_t>& time_hrs, 
...
// e_stat->SetPoint(n_measurements, 56.5, 3.14e-5);
// e_stat->SetPointError(n_measurements, 0., .06*3.627e-5);
...
///////// PLOTTING STUFF ///////////
e_stat->SetMarkerSize(.5);
e_stat->SetMarkerStyle(8);
